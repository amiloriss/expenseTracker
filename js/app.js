class UI {
  ...
  submitBudgetForm() {
    ...
    if (value === '' || value < 0) {
      ...
      this.budgetFeedback.innerHTML = `<div>Value cannot be empty or negative</div>`;
  ...
  submitExpenseForm() {
    ...
    if (expenseValue === '' || amountValue === '' || amountValue < 0) {
      ...
      this.expenseFeedback.innerHTML = `<div>No one value cannot be empty or negative</div>`;
